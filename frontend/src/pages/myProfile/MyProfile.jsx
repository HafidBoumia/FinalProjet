...
export default function MyProfile() {
    ...
    const handleFileChange = (e) => {
        ...
        dispatch(updateUserData({ token, updatedData: formData }));
    };

    const handleSubmit = async () => {
        await dispatch(updateUserData({ token, updatedData: userData }));
    };

    const handleSubmitLang = async () => {
        if (!languageId) {
            await dispatch(addLanguage(LanguagesData));
        } else {
            await dispatch(updateLanguage({ id: languageId, updatedData: LanguagesData }));
        }
        setOpen(null);
    };
    ...
    const handleSubmitSkill = async () => {
        await dispatch(addSkills(SkillsData));
        setOpen(null);
    };
                ...
                <div className='content1'>
                    ...
                    <div className='items'>
                        <div className='relative inline-block'>
                            <img
                                src={userData.profileImg ? `http://127.0.0.1:8000/images/profile/${userData?.profileImg}` : 'userPic.png'}
                        ...
                        {isOpen === 'profile' ? (
                            ...
                            <>
                                ...
                                <time dateTime="2014-08-16 19:00" className="block font-medium text-sm text-gray-500">Joined on August 2014</time>
                    ...
                    <div className="content2">
                        ...
                        <div className="items">
                            ...
                            <div className='label'>
                                ...
                                {isOpen === 'skills' && (
                                    <div className='buttons'>
                                        <button className='button1' onClick={handleSubmitSkill}>Save</button>
                                        <button className='button2' onClick={cancelButton}>Cancel</button>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className='itemDiv2'>
                            <div className="items">
                                <div className='label'>
                                    ...
                                    {isOpen === 'languages' && (
                                        <div className='buttons'>
                                            <button className='button1' onClick={handleSubmitLang}>Save</button>
                                            <button className='button2' onClick={cancelButton}>Cancel</button>
                                        </div>
                                    )}
                                </div>
